...
![parqeye](https://repo.x-cmd.io/parqeye.svg?lang=zh)
...
合计: **4,243** 行代码（覆盖前 5 种语言、共 **34** 个文件）。
...
- **上游仓库**: <https://github.com/kaushiksrini/parqeye>
- **许可证**: MIT
...
- **Star**: 679 · **Fork**: 14 · **开放 issue**: 14 · **贡献者**: 2

## 累计统计

- **发布数**: 2 · **已合并 PR**: 23 · **开放 PR**: 4 · **已关闭 issue**: 2 · **开放 issue**: 12 · **提交数**: 188

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 1 | 7 | 2 | 0 | 0 | 9 |
| last60d | 2026-07-13 | 1 | 9 | 2 | 0 | 1 | 11 |
| 90d | 2026-06-13 | 1 | 14 | 2 | 0 | 1 | 24 |
| last180d | 2026-03-15 | 1 | 14 | 2 | 0 | 1 | 24 |
| 360d | 2025-09-16 | 2 | 23 | 4 | 2 | 12 | 113 |
| last720d | 2024-09-21 | 2 | 23 | 4 | 2 | 12 | 188 |
...
在 [repology.org](https://repology.org/project/parqeye) 上共有 **6** 个发行版报告此项目。**5** 个 ✅ 已是最新上游版本，**0** 个 ⚠️ 使用旧版本。
...
parqeye 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `parqeye` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/parqeye.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T19:22:01Z._
